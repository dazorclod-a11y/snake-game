...
self.addEventListener('install', (event) => {
  ...
  // НЕ активируем сразу — ждём команды от страницы (кнопка «Обновить» в баннере)
});

// Активация по команде страницы: пользователь нажал «Обновить» в баннере
